...
# Force root privileges explicitly
USER root

# 1. Install system-level libraries for OpenCV and compilation tools
...
# 2. Install specialized WanVideo and auxiliary custom node extensions (Using absolute paths for git)
RUN /usr/bin/git clone https://github.com/IAMCCS/IAMCCS-nodes /comfyui/custom_nodes/IAMCCS-nodes && \
...
# FIXED: Cloned the correct SVI Extender repository with recursive submodules using absolute git path
RUN /usr/bin/git clone --recursive https://github.com/Well-Made/ComfyUI-WanVideoWrapper-SVI /comfyui/custom_nodes/ComfyUI-WanVideoWrapper-SVI && \
...
RUN /usr/bin/git clone --recursive https://github.com/Well-Made/ComfyUI-Wan-SVI2Pro-FLF /comfyui/custom_nodes/ComfyUI-Wan-SVI2Pro-FLF && \
...
RUN /usr/bin/git clone https://github.com/kijai/ComfyUI-WanVideoWrapper /comfyui/custom_nodes/ComfyUI-WanVideoWrapper && \
...
RUN /usr/bin/git clone https://github.com/kijai/ComfyUI-KJNodes /comfyui/custom_nodes/ComfyUI-KJNodes \
    && cd /comfyui/custom_nodes/ComfyUI-KJNodes \
    && (/usr/bin/git checkout 79f529a84a8c20fe5dcdfa984c6be7a94102c014 2>/dev/null || \
        (/usr/bin/git fetch origin 79f529a84a8c20fe5dcdfa984c6be7a94102c014 --depth=1 && /usr/bin/git checkout 79f529a84a8c20fe5dcdfa984c6be7a94102c014) || \
        echo "WARN: falling back to default branch HEAD")

RUN /usr/bin/git clone https://github.com/Kosinkadink/ComfyUI-VideoHelperSuite /comfyui/custom_nodes/ComfyUI-VideoHelperSuite \
    && cd /comfyui/custom_nodes/ComfyUI-VideoHelperSuite \
    && (/usr/bin/git checkout 8550981384301e9bc5bfea83e5c2c75258102593 2>/dev/null || \
        (/usr/bin/git fetch origin 8550981384301e9bc5bfea83e5c2c75258102593 --depth=1 && /usr/bin/git checkout 8550981384301e9bc5bfea83e5c2c75258102593) || \
        echo "WARN: falling back to default branch HEAD")

RUN /usr/bin/git clone https://github.com/theUpsider/ComfyUI-Logic.git /comfyui/custom_nodes/ComfyUI-Logic
